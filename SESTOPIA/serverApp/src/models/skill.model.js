...
Skill.create = function (newSkill, tool_id, roles_id, se_id, result) {
  dbConn.query("INSERT INTO skill SET ?", newSkill, function (err, res) {
    if (err) {
      ...
      dbConn.query(
        "INSERT INTO skilltool (skill_id, tool_id) VALUES?",
        [value],
        function (err, res) {
          if (err) {
            console.log("error: ", err);
      ...
      dbConn.query(
        "INSERT INTO rolesforskill (skill_id, roles_id) VALUES?",
        [value],
        function (err, res) {
          if (err) {
            console.log("error: ", err);
      ...
      dbConn.query(
        "INSERT INTO seskill SET skill_id=?, se_id=?",
        [skill_id, se_id],
        function (err, res) {
          if (err) {
            console.log("error: ", err);
...
//find the skill infotamtion by skill id
