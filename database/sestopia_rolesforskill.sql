...
CREATE TABLE `rolesforskill` (
  ...
  KEY `rolesid_idx` (`roles_id`),
  CONSTRAINT `rolesid` FOREIGN KEY (`roles_id`) REFERENCES `roles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2020-07-20 21:43:13
